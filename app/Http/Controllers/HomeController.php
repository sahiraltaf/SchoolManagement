...
class HomeController extends Controller
{
    ...
    {   
        ...
        if ($user->hasRole('Admin')) {
            ...
            // dd($parents, $teachers, $students, $subjects, $classes);
            return view('home', compact('parents','teachers','students','subjects','classes'));

        } elseif ($user->hasRole('Teacher')) {
            
            $teacher = Teacher::with(['user', 'subjects', 'classes', 'students'])->withCount('students', 'subjects','classes')->findOrFail($user->teacher[0]->id);
            // dd($teacher);
